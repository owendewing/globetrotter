    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.inputContainer}>
                <Input placeholder="example@email.com / username" onChangeText={setIdentifier} value={identifier} textHeader="Email or Username" />
                ...
                onPress={() => handleLogin()} 
                backgroundColor="#162D3A" color="white" />
                </View>
            </View>
        </SafeAreaView>
    );
